...
| 当前本地能力 | Blueprint Revision、Dry Run、Connector Preflight/Discovery、资源归属计划、本地审批、可恢复/可重试的 Local Apply Simulator、XState 状态推进、Delivery Report、Fake Provider Adapter 契约测试 |
