...
export const en = {
  ...
  artifact: {
    ...
    'template-root-tsconfig': 'Web app TypeScript configuration',
    'template-eslint-config': 'ESLint flat configuration',
    'template-smoke-script': 'Post-build smoke check',
    'template-vite-config': 'Vite React configuration',
    'template-web-package': 'Web application package',
    'template-web-index': 'Vite web entry',
    'template-web-main': 'Web application entrypoint',
    'template-web-styles': 'Web application styles',
    'template-api-package': 'API application package',
    'template-api-index': 'Hono API entrypoint',
    'template-api-test': 'API health unit test',
    'template-api-vercel': 'Vercel API configuration',
    'template-cloudflare': 'Cloudflare Pages configuration',
    'template-gitignore': 'Product git ignore rules',
    'template-quality-workflow': 'GitHub quality workflow',
    'template-build-script': 'Static build / inject script',
    'template-index': 'Landing page entry',
    'template-styles': 'Landing page styles',
    'template-app-js': 'Landing page script',
    'template-forms-gitignore': 'Landing page git ignore rules',
    'ext-manifest-config': 'Extension manifest (MV3)',
    'ext-vite-config': 'Vite + crx config',
    'ext-package': 'Extension package',
    'ext-tsconfig': 'Extension tsconfig',
    'ext-popup-html': 'Popup HTML',
    'ext-popup-ts': 'Popup entry',
    'ext-popup-css': 'Popup styles',
    'ext-options-html': 'Options HTML',
    'ext-options-ts': 'Options entry',
    'ext-background-ts': 'Background service worker',
    'ext-content-ts': 'Content script',
    'ext-readme': 'Extension README',
    'ext-gitignore': 'Extension git ignore rules',
    'ext-quality-workflow': 'GitHub quality workflow',
    'desktop-package': 'Desktop package',
    'desktop-tsconfig': 'Desktop tsconfig',
    'desktop-vite-config': 'Vite config',
    'desktop-index-html': 'Webview HTML',
    'desktop-main-ts': 'Webview entry',
    'desktop-styles': 'Webview styles',
    'desktop-cargo-toml': 'Rust crate manifest',
    'desktop-build-rs': 'Rust build script',
    'desktop-lib-rs': 'Rust core',
    'desktop-main-rs': 'Rust entry point',
    'desktop-tauri-conf': 'Tauri config',
    'desktop-icon-script': 'Placeholder icon generator',
    'desktop-gitignore': 'Desktop git ignore rules',
    'desktop-readme': 'Desktop README',
    'desktop-quality-workflow': 'GitHub quality workflow',
    'distribution-guide': 'Distribution and signing guide',
    'mobile-package': 'Mobile package (Expo)',
    'mobile-app-json': 'Expo app configuration',
    'mobile-tsconfig': 'Mobile tsconfig',
    'mobile-babel-config': 'Babel configuration',
    'mobile-layout': 'Root navigator',
    'mobile-home-screen': 'Home screen',
    'mobile-eas-json': 'EAS build profiles',
    'mobile-gitignore': 'Mobile git ignore rules',
    'mobile-readme': 'Mobile README',
    'mobile-quality-workflow': 'GitHub quality workflow',
    'mcp-package': 'MCP server package',
    'mcp-tsconfig': 'MCP tsconfig',
    'mcp-tsconfig-build': 'MCP build tsconfig',
    'mcp-eslint-config': 'ESLint flat configuration',
    'mcp-vitest-config': 'Vitest configuration',
    'mcp-server': 'MCP server and tools',
    'mcp-entry': 'MCP stdio entry',
    'mcp-test': 'MCP server tests',
    'mcp-gitignore': 'MCP git ignore rules',
    'mcp-readme': 'MCP server README',
    'mcp-quality-workflow': 'GitHub quality workflow',
    'template-root-package': {
      'web-app': 'Web app workspace package',
      'landing-page': 'Landing page package',
    },
    'template-readme': {
      'web-app': 'Web app template README',
      'landing-page': 'Landing page README',
    },
  },
  evidence: {
